...
import { Activity, AlertTriangle, ArrowRight, BrainCircuit, CalendarRange, Check, ChevronDown, CircleDot, Gauge, Map, Menu, MoreHorizontal, Navigation, Route, Search, Settings2, ShieldCheck, Sparkles, Stethoscope, Undo2, Users, X } from "lucide-react";
...
const navItems = [[Gauge, "Command"], [Map, "Live map"], [Route, "Routes"], [Users, "Technicians"], [Activity, "Performance"], [CalendarRange, "Capacity Planning"], [Stethoscope, "Diagnostic Copilot"], [BrainCircuit, "AgentOps"]] as const;
...
export default function Home() {
  ...
  const specializedView = agentOpsView || diagnosticView || capacityView;
