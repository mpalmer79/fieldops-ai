...
export default function Home() {
  ...
  const viewTitle = agentOpsView ? "AI operations" : diagnosticView ? "Vehicle diagnostics" : capacityView ? "Capacity planning" : benchmarkView ? "Simulation lab" : "Service command";
  const viewDescription = agentOpsView ? "Agent fleet governance and release safety" : diagnosticView ? "Evidence, safety, parts, and repair outcomes" : capacityView ? "Appointment forecasts, staffing risk, and scenario decisions" : benchmarkView ? "Dealer-group scale, regression gates, and benchmark evidence" : "Rooftop 01 · live service operation";
